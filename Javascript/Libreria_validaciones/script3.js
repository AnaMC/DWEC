...
var formulario = document.getElementById("formulario");
    ...
    class Validar {
        ...
        constructor(formulario) {
            ...
            //Para agregarle el manejador de eventos al formulario utilizamos una función flecha, de este modo le decimos "esto va aquí tonto".
        ...
        //No estatico para que podamos llamarlo con this, si no, necesitamos ->  Validar.comprobar(); 
        comprobar(){
            let longitud = Validar.valLongitud(3, 8, null);
            let email = Validar.valEmail();
            let genero = Validar.valSexo();
